    ...
    <div class="col-12">
      ...
      ?>
        ...
        <div class="card-header">
          <h4 class="card-title"> How Everything Works? Management</h4>
            ...
            <table class="table table-striped table-bordered zero-configuration">
              ...
              <?php
                ...
                <tr>
                  ...
                  <td><a href="<?php echo base_url() . 'howitworkedit/'. insep_encode($result->id)  ?>"title="Edit this work"><i class="fa fa-edit"> </i> </a></td>
