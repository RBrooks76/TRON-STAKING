      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="px-3">
            ...
            <form class="form" id="change_pass" method="post">

              <div class="form-body">
                <h4 class="form-section"><i class="ft-info"></i>Change Password</h4>
                <div class="row justify-content-md-center">
                  <div class="form-group col-md-6 mb-2">
                    <label for="userinput1">Current Password</label>
                    <input type="Password" id="cpass" class="form-control border-primary" placeholder="Current Password" name="cpass" value="">
                  </div>
