                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="px-3">
                                    ...
                                    <form class="form" id="edit_cms" method="post" enctype="multipart/form-data">
                                        <div class="form-body">
                                            <h4 class="form-section"><i class="ft-info"></i>Edit CMS</h4>
                                                    ...
                                                    <fieldset class="form-group">
                                                        ...
                                                        <select class="form-control" id="language" name="language"
                                                            ...
                                                            <option value="<?php echo $value->id;?>"
                                                                <?php if($cms->language == $value->id ) {echo 'selected';} ?>>
                                            ...
                                            <div class="row justify-content-md-center">
                                                <div class="form-group col-md-6 mb-2">
                                                    ...
                                                    <input type="text" id="heading" class="form-control border-primary"
                                                        placeholder="Heading" name="heading"
                                                        value="<?php echo $cms->heading ; ?>">
                                                </div>
                                            </div>
                                            ...
                                            <?php if($cms->cms_image){?>
                                            <div class="row justify-content-md-center">
                                                <div class="form-group col-md-6 mb-2">
                                                    <img height="100" weight="100"
                                                        src="<?php echo base_url().'ajqgzgmedscuoc/img/cms/'.$cms->cms_image;?>" />
                                                </div>
                                            </div>
                                            <?php } ?>
                                            ...
                                            <!-- <div class="row justify-content-md-center">
                                                <div class="form-group col-md-6 mb-2">
                                                    <label for="userinput1">Meta Keyword</label>
                                                    <input type="text" id="meta_keyword"
                                                        class="form-control border-primary" placeholder="Meta Keyword"
                                                        name="meta_keyword"
                                                        value="<?php //echo $cms->meta_keywords ; ?>">
                                                </div>
                                            </div> -->

                                            <!-- <div class="row justify-content-md-center">
                                                <div class="form-group col-md-6 mb-2">
                                                    <label for="userinput1">Meta Description</label>
                                                    <input type="text" id="meta_description"
                                                        class="form-control border-primary"
                                                        placeholder="Meta Description" name="meta_description"
                                                        value="<?php //echo $cms->meta_description ; ?>">
                                                </div>
                                            </div> -->

                                            <!-- <div class="row justify-content-md-center">
                                                <div class="form-group col-md-6 mb-2">
                                                    <label for="userinput1">Link</label>
                                                    <input type="text" id="link" class="form-control border-primary"
                                                        placeholder="Link" name="link"
                                                        value="<?php echo $cms->link ; ?>">
                                                </div>
                                            </div> -->

                                            <!-- <div class="row justify-content-md-center">
                                                <div class="form-group col-md-6 mb-2">
                                                    <label for="userinput1">Join Link</label>
                                                    <input type="text" id="joinLink" class="form-control border-primary"
                                                        placeholder="joinLink" name="joinLink"
                                                        value="<?php echo $cms->link ; ?>">
                                                </div>
                                            </div> -->
                                            ...
                                            <div class="row justify-content-md-center">
                                                <div class="form-group col-md-6 mb-2">
                                                    ...
                                                    <textarea class="form-control" id="content_description"
                                                        ...
                                                        rows="20"><?php echo $cms->content_description; ?></textarea>
