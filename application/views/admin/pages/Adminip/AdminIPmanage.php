    ...
    <div class="col-12">
      ...
      ?>
        ...
        <div class="card-header">
          <h4 class="card-title">
          Admin IP Management</h4>
          
        </div>

      <div class="text-right d-none d-sm-none d-md-none d-lg-block">
               
          <a href="<?php echo base_url() . 'adminipadd' ?>">  <button type="button" class="btn btn-success btn-raised mr-3"><i class="fa fa-plus"></i> Add IP</button> </a>
          ...
          <div class="card-body card-dashboard table-responsive">
            <table class="table table-striped table-bordered zero-configuration">
              ...
              <?php
                if ($adminip) {
                  $i = 1;
                  foreach($adminip as $result) { ?>
                <tr>
                  <td><?php echo $i; ?></td>
                  <td><?php echo $result->ip_address; ?></td>
                  <td><?php  if($result->status == 1) { echo 'Active'; } else { echo 'Deactive';} ?></td>
                  <td>
                    <a href="<?php echo base_url() . 'adminipedit/'. insep_encode($result->id)  ?>"title="Edit this IP"><i class="fa fa-edit"> </i> </a>
                    <a href="<?php echo base_url() . 'adminipdelete/'. insep_encode($result->id)  ?>"title="Delete this IP"><i class="fa fa-trash"> </i> </a>
                  </td>
