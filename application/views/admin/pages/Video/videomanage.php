  ...
  <div class="row">
    <div class="col-12">
      ...
      <div class="text-right d-none d-sm-none d-md-none d-lg-block">
               ...
               <a href="<?php echo base_url() . 'videoadd' ?>">  <button type="button" class="btn btn-success btn-raised mr-3"><i class="fa fa-plus"></i> Add Video</button> </a>
        </div>
            ...
            <table class="table table-striped table-bordered zero-configuration">
              ...
              <?php
                ...
                <tr>
                  ...
                  <td>
                    <a href="<?php echo base_url() . 'videoedit/'. insep_encode($result->id)  ?>"title="Edit this Video"><i class="fa fa-edit"> </i> </a>
                    <a href="<?php echo base_url() . 'videodelete/'. insep_encode($result->id)  ?>"title="Delete this Video"><i class="fa fa-trash"> </i> </a>
                  </td>
