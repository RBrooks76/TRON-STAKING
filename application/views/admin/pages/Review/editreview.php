               ...
               <div class="row justify-content-md-center">
                    ...
                    <fieldset class="form-group">
                     ...
                     <?php foreach($lang as $key => $value){ ?>
                      <option value="<?php echo $value->id;?>"  <?php if($review->language == $value->id ) {echo 'selected';} ?> ><?php echo $value->lang_name;     ?></option> 
                      <?php } ?> 
                      </select>
                    </fieldset>
                  </div>
                ...
                <div class="row justify-content-md-center">
                  <div class="form-group col-md-6 mb-2">
                    <label for="userinput1">URL Value</label>
                    <input type="text" id="url_value" class="form-control border-primary" placeholder="URL Value" name="url_value" value="<?php echo $review->url_value ; ?>">
                  </div>
