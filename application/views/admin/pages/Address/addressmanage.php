    ...
    <div class="col-12">
      ...
      ?>
        ...
        <div class="card-header">
          <h4 class="card-title">Contract Address Management</h4>
          ...
          <div class="card-body card-dashboard table-responsive">
            <table class="table table-striped table-bordered zero-configuration">
              ...
              <?php
                ...
                <tr>
                  <td><?php echo $i; ?></td>
                  <td><?php echo $result->heading.' - '.insep_decode($result->address_name); ?></td>
                  <!-- <td><a href="<?php //echo base_url() . 'addressedit/'. insep_encode($result->id)  ?>"title="Edit this address"><i class="fa fa-edit"> </i> </a></td> -->
