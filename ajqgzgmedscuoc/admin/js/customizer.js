$(document).ready(function() {
  ...
  if ($("body.layout-dark.layout-transparent").length > 0) {
    ...
    $("#ll-switch").on("click", function() {
      $(".sidebar-background").css(
        "background-image",
        "app-ajqgzgmedscuoc/img/sidebar-bg/01.jpg"
      );
    });
  }
  ...
  $(".cz-bg-color span").on("click", function() {
    ...
    if (bgColor == "white") {
      $(".logo-img img").attr("src", "app-ajqgzgmedscuoc/img/logo-dark.png");
    } else {
      if ($(".logo-img img").attr("src") == "app-ajqgzgmedscuoc/img/logo-dark.png") {
        $(".logo-img img").attr("src", "app-ajqgzgmedscuoc/img/logo.png");
      }
    }
  });
  ...
  $("#dl-switch").on("click", function() {
    ...
    if ($("body").hasClass("layout-transparent")) {
      ...
      $(".sidebar-background").css(
        "background-image",
        "url(app-ajqgzgmedscuoc/img/sidebar-bg/01.jpg)"
      );
      $(".app-sidebar").attr("data-background-color", "black");
    } else {
